...
func TestReadCredentials(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			state: map[string]string{
				"api.codewhisperer.profile": "arn:aws:codewhisperer:us-east-1:000000000000:profile/EXAMPLE",
			},
			check: func(t *testing.T, c *Credentials) {
				if c.ProfileARN != "arn:aws:codewhisperer:us-east-1:000000000000:profile/EXAMPLE" {
